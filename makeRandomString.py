...
##A collection of methods that generate text in various ways. Mostly 
##pretty simple.
##balancedAlph is used to pick letters from if one wants a random string 
##with letters appearing roughly as frequently as they would in the 
##english language.
